...
// Wenn dieser Char empfangen wird, ist der Buffer komplett
#define READ_TO_CHAR       33
// Wenn dieser Char empfangen wird, resetet sich der Schrittmotor auf 0
...
// Prädeklarationen von Funktionen
